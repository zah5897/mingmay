...
public class FriendCircleAdapter extends BaseAdapter {
	...
	private FriendCircle page;
	private ImageLoader imgLoader;
	public FriendCircleAdapter(FriendCircle page,ArrayList<Clothesinfo> data){
		this.page=page;
		this.data=data;
		imgLoader=new ImageLoader(page);
	}
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		 ...
		 if(arg1==null){
			 arg1=page.getLayoutInflater().inflate(R.layout.layout_item_friend_circle, null);
			 viewHolder=new ViewHolder();
			 viewHolder.icon=(ImageView) arg1.findViewById(R.id.head_icon);
			 viewHolder.clothesImg=(ImageView) arg1.findViewById(R.id.detial_img);
